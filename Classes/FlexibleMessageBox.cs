    ...
    public class FlexibleMessageBox
    {
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private FlexibleMessageBoxForm()
            {
                ...
                _ = Enum.TryParse<TwoLetterISOLanguageID>(CultureInfo.CurrentUICulture.TwoLetterISOLanguageName, out this.languageID);
            ...
            private string GetButtonText(ButtonID buttonID)
            {
                ...
                return this.languageID switch
                {
                    ...
                    TwoLetterISOLanguageID.en => BUTTON_TEXTS_ENGLISH_EN[buttonTextArrayIndex],
            ...
            private void FlexibleMessageBoxForm_Shown(object sender, EventArgs e)
            {
                ...
                var buttonIndexToFocus = this.defaultButton switch
                {
